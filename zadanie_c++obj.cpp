...
int main() {
    ...
    do {
      ...
      // Wyświetlenie menu
        ...
        cout << "1. Snajper prezyjny" << endl;
        cout << "2. Snajper z bronią szybszą" << endl;
        ...
        switch (wybor) {
        case 1: {
            cout << "Wybrałeś klase Snajper prezyjny" << endl;
            break;
        }
        case 2:
            cout << "Wybrałeś klase Snajper z bronią szybszą" << endl;
            break;
        case 3:
            cout << "Wybrales Opcje 3\n"; {
                ...
                board[enemyX][enemyY] = 'E'; // Umieszczenie gracza na planszy
                char move;
                while (true) {
                    ...
                    cout << "Ruch (w/g/s/d/): Atack(q): Przeładowanie broni(r):";
                    ...
                    cout << "klinknij k, jeśli chcesz zakończyć gre: " << endl;
